  ...
  describe path do
    ...
    describe "url" do
      ...
      it "check for successful URL" do
        ...
        # NOT 2017 or 2019: 2000..2007, 2009..2016, 2018, 2020..2025
        # A: 2000..2009, 2013..2016, 2023..2025
        # B: 2010..2012, 2018, 2020..2022
        case Date.parse( advisory['date'].to_s ).year
        when 2019
          # Assume only 1 value
          ...
          begin
            ...
            expect([200, 301, 302, 308, 403]).to include(
              response.code.to_i), ">URL - #{uri} - #{response.code.to_i}"
